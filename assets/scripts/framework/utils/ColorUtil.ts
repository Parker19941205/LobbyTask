...
export default class ColorUtil {
    ...
    public static hexToRgba(hex: string) {
        ...
        return new cc.Color(r, g, b, a)   //{ r, g, b, a };
    }
     ...
     * 获取成就颜色
     * @param index 
     * @returns N为白色、NR为蓝色、R为紫色、SR为粉色、
                SSR为橙色、UR为金色
     */
    public static getRarityColor(index: number) {
        let rarityColorList = ["#FFFFFF","#B2E5E6","#BE96D9","#FBA0AF","#C88A64","#FFD700"]
        return rarityColorList[index];
    }
